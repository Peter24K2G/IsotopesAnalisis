...
total_pages = 7  # Cambia esto según el número de páginas que necesites
...
#----------------------------------------------------------------------------------------------
    ...
    st.divider()
    st.markdown("### Resultados Bombeo Pozo UNAL")
    df = pd.read_csv("BDIsotopos.csv",sep=",")
    ...
    ax.text(-9.87,-71.9,f"δ18O (Anual)",ha='left')
...
#----------------------------------------------------------------------------------------------
    ...
    st.markdown("""
    ## Análisis de datos Hidrometeorológicos (Triple Frontera)
    En esta sección se estudian estaciones hidrometeorológicas parte de la red de estaciones de IDEAM, en las cuales por medio de un análisis no paramétrico se estudian las tendencias de sus variables de medición
    """)
    st.image("images/Estaciones.jpg")
    st.divider()
    st.markdown(""" ### Series de tiempo por cada variable 
    1990 - 2024""")
    st.image("images/Series.png")
    st.divider()
    st.markdown(""" ### Series de tiempo por cada variable 
    2018 - 2024""")
